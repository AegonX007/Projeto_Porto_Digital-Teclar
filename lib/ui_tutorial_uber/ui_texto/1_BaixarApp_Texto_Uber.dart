...
class BaixarApp_Texto_Uber extends StatefulWidget {
  ...
  BaixarApp_Texto_Uber(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _BaixarApp_Texto_UberState createState() =>
      _BaixarApp_Texto_UberState(cont, nome, link);
}

class _BaixarApp_Texto_UberState extends State<BaixarApp_Texto_Uber> {
  int cont;
  String nome;
  String link;

  _BaixarApp_Texto_UberState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
