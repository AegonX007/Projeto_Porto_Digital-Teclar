...
class BaixarAPP_Audio_Uber extends StatefulWidget {
  ...
  BaixarAPP_Audio_Uber(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _BaixarAPP_Audio_UberState createState() =>
      _BaixarAPP_Audio_UberState(cont, nome, link);
}

// ignore: camel_case_types
class _BaixarAPP_Audio_UberState extends State<BaixarAPP_Audio_Uber> {
  int cont;
  String nome;
  String link;

  _BaixarAPP_Audio_UberState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
