...
class PedirAPP_Video_Uber extends StatefulWidget {
  int cont;
  String nome;
  String link;

  PedirAPP_Video_Uber(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _PedirAPP_Video_UberState createState() =>
      _PedirAPP_Video_UberState(cont, nome, link);
}

class _PedirAPP_Video_UberState extends State<PedirAPP_Video_Uber> {
  int cont;
  String nome;
  String link;

  _PedirAPP_Video_UberState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
