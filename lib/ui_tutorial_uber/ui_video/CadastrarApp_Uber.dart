...
class CadastrarAPP_Video_Uber extends StatefulWidget {
  int cont;
  String nome;
  String link;

  CadastrarAPP_Video_Uber(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _CadastrarAPP_Video_UberState createState() =>
      _CadastrarAPP_Video_UberState(cont, nome, link);
}

class _CadastrarAPP_Video_UberState extends State<CadastrarAPP_Video_Uber> {
  int cont;
  String nome;
  String link;

  _CadastrarAPP_Video_UberState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
