...
class BaixarAPP_Video_Uber extends StatefulWidget {
  ...
  BaixarAPP_Video_Uber(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _BaixarAPP_Video_UberState createState() =>
      _BaixarAPP_Video_UberState(cont, nome, link);
}

// ignore: camel_case_types
class _BaixarAPP_Video_UberState extends State<BaixarAPP_Video_Uber> {
  int cont;
  String nome;
  String link;

  _BaixarAPP_Video_UberState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
