...
class EntrarAPP_Video_Uber extends StatefulWidget {
  int cont;
  String nome;
  String link;

  EntrarAPP_Video_Uber(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _EntrarAPP_Video_UberState createState() =>
      _EntrarAPP_Video_UberState(cont, nome, link);
}

class _EntrarAPP_Video_UberState extends State<EntrarAPP_Video_Uber> {
  int cont;
  String nome;
  String link;

  _EntrarAPP_Video_UberState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
