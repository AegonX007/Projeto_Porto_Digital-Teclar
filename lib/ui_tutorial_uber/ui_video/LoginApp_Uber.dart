...
class LoginAPP_Video_Uber extends StatefulWidget {
  int cont;
  String nome;
  String link;

  LoginAPP_Video_Uber(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _LoginAPP_Video_UberState createState() =>
      _LoginAPP_Video_UberState(cont, nome, link);
}

class _LoginAPP_Video_UberState extends State<LoginAPP_Video_Uber> {
  int cont;
  String nome;
  String link;

  _LoginAPP_Video_UberState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
