...
class BaixarAPP_Audio_Facebook extends StatefulWidget {
  int cont;
  String nome;
  String link;

  BaixarAPP_Audio_Facebook(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _BaixarAPP_Audio_FacebookState createState() =>
      _BaixarAPP_Audio_FacebookState(cont, nome, link);
}

// ignore: camel_case_types
class _BaixarAPP_Audio_FacebookState extends State<BaixarAPP_Audio_Facebook> {
  int cont;
  String nome;
  String link;

  _BaixarAPP_Audio_FacebookState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
