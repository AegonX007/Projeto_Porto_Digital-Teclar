...
class LoginAPP_Video_Facebook extends StatefulWidget {
  int cont;
  String nome;
  String link;

  LoginAPP_Video_Facebook(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _LoginAPP_Video_FacebookState createState() =>
      _LoginAPP_Video_FacebookState(cont, nome, link);
}

class _LoginAPP_Video_FacebookState extends State<LoginAPP_Video_Facebook> {
  int cont;
  String nome;
  String link;

  _LoginAPP_Video_FacebookState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
