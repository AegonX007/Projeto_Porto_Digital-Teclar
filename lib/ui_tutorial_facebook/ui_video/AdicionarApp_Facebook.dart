...
class AdicionarAPP_Video_Facebook extends StatefulWidget {
  int cont;
  String nome;
  String link;

  AdicionarAPP_Video_Facebook(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _AdicionarAPP_Video_FacebookState createState() =>
      _AdicionarAPP_Video_FacebookState(cont, nome, link);
}

class _AdicionarAPP_Video_FacebookState
    extends State<AdicionarAPP_Video_Facebook> {
  int cont;
  String nome;
  String link;

  _AdicionarAPP_Video_FacebookState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
