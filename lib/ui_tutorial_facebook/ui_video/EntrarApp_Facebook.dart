...
class EntrarAPP_Video_Facebook extends StatefulWidget {
  int cont;
  String nome;
  String link;

  EntrarAPP_Video_Facebook(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _EntrarAPP_Video_FacebookState createState() =>
      _EntrarAPP_Video_FacebookState(cont, nome, link);
}

class _EntrarAPP_Video_FacebookState extends State<EntrarAPP_Video_Facebook> {
  int cont;
  String nome;
  String link;

  _EntrarAPP_Video_FacebookState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
