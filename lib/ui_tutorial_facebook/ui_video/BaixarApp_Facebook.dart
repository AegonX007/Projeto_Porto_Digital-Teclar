...
class BaixarAPP_Video_Facebook extends StatefulWidget {
  int cont;
  String nome;
  String link;

  BaixarAPP_Video_Facebook(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _BaixarAPP_Video_FacebookState createState() =>
      _BaixarAPP_Video_FacebookState(cont, nome, link);
}

// ignore: camel_case_types
class _BaixarAPP_Video_FacebookState extends State<BaixarAPP_Video_Facebook> {
  int cont;
  String nome;
  String link;

  _BaixarAPP_Video_FacebookState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
