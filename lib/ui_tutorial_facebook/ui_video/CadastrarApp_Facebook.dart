...
class CadastrarAPP_Video_Facebook extends StatefulWidget {
  int cont;
  String nome;
  String link;

  CadastrarAPP_Video_Facebook(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _CadastrarAPP_Video_FacebookState createState() =>
      _CadastrarAPP_Video_FacebookState(cont, nome, link);
}

class _CadastrarAPP_Video_FacebookState
    extends State<CadastrarAPP_Video_Facebook> {
  int cont;
  String nome;
  String link;

  _CadastrarAPP_Video_FacebookState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
