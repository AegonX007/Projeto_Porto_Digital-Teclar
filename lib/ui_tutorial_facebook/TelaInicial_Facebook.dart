...
import 'package:material_splash_screen/ui_tutorial_facebook/ui_audio/BaixarApp_Audio_Facebook.dart';
import 'package:material_splash_screen/ui_tutorial_facebook/ui_texto/1_BaixarApp_Texto_Facebook.dart';
import 'package:material_splash_screen/ui_tutorial_facebook/ui_video/AdicionarApp_Facebook.dart';
import 'package:material_splash_screen/ui_tutorial_facebook/ui_video/BaixarApp_Facebook.dart';
import 'package:material_splash_screen/ui_tutorial_facebook/ui_video/CadastrarApp_Facebook.dart';
import 'package:material_splash_screen/ui_tutorial_facebook/ui_video/EntrarApp_Facebook.dart';
import 'package:material_splash_screen/ui_tutorial_facebook/ui_video/LoginApp_Facebook.dart';

class TelaFacebook extends StatelessWidget {
  final String tipo;
  final int nome;

  const TelaFacebook({Key key, this.tipo, this.nome}) : super(key: key);
  ...
  void verificarTela(context, String nome, int cont) {
    if (cont == 1) {
      if (tipo == "ASSISTINDO") {
        Future.delayed(Duration(milliseconds: 200)).then((_) {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => BaixarAPP_Video_Facebook(
                    cont,
                    nome,
                    "https://www.youtube.com/watch?v=5kXYC265yn8",
                  )));
        });
      } else if (tipo == "OUVINDO") {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => BaixarAPP_Audio_Facebook(
                  cont,
                  nome,
        ...
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => BaixarApp_Texto_Facebook(
                  cont,
                  nome,
                  "https://www.youtube.com/watch?v=90Ur7UO318I",
                )));
      ...
      Future.delayed(Duration(milliseconds: 200)).then((_) {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => EntrarAPP_Video_Facebook(
                  cont,
                  nome,
                  "https://www.youtube.com/watch?v=5kXYC265yn8",
                )));
      ...
      Future.delayed(Duration(milliseconds: 200)).then((_) {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => CadastrarAPP_Video_Facebook(
                  cont,
                  nome,
                  "https://www.youtube.com/watch?v=5kXYC265yn8",
                )));
      ...
      Future.delayed(Duration(milliseconds: 200)).then((_) {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => LoginAPP_Video_Facebook(
                  cont,
                  nome,
                  "https://www.youtube.com/watch?v=5kXYC265yn8",
                )));
      ...
      Future.delayed(Duration(milliseconds: 200)).then((_) {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => AdicionarAPP_Video_Facebook(
                  cont,
                  nome,
                  "https://www.youtube.com/watch?v=5kXYC265yn8",
                )));
