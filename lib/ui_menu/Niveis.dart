...
class TelaNiveis extends StatelessWidget {
  ...
  const TelaNiveis({Key key, this.page}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    _verificarBotao() {
      print("PQPPPPPPPPPPPP");
      if (premium == true) {
        print("PQPPPPPPPP");
        botaoAvan = buildButton(context, "images/diamante_premium.png",
            "AVANÇADO", 3, sizeWidth, sizeCard);
        botaoMed = buildButton(context, "images/diamante_premium.png", "MÉDIO",
            2, sizeWidth, sizeCard);
      } else {
        print(premium);
        botaoAvan = buildButton2(context, "images/diamante_premium.png",
            "AVANÇADO", 3, sizeWidth, sizeCard);
        botaoMed = buildButton2(context, "images/diamante_premium.png", "MÉDIO",
            2, sizeWidth, sizeCard);
      }
    }
