...
class BaixarApp_Texto_Instagram extends StatefulWidget {
  int cont;
  String nome;
  String link;

  BaixarApp_Texto_Instagram(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _BaixarApp_Texto_InstagramState createState() =>
      _BaixarApp_Texto_InstagramState(cont, nome, link);
}

class _BaixarApp_Texto_InstagramState extends State<BaixarApp_Texto_Instagram> {
  int cont;
  String nome;
  String link;

  _BaixarApp_Texto_InstagramState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
