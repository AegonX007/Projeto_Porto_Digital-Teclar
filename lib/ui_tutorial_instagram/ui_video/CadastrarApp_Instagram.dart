...
class CadastrarAPP_Video_Instagram extends StatefulWidget {
  int cont;
  String nome;
  String link;

  CadastrarAPP_Video_Instagram(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _CadastrarAPP_Video_InstagramState createState() =>
      _CadastrarAPP_Video_InstagramState(cont, nome, link);
}

class _CadastrarAPP_Video_InstagramState
    extends State<CadastrarAPP_Video_Instagram> {
  int cont;
  String nome;
  String link;

  _CadastrarAPP_Video_InstagramState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  Future<Curso> _recuperarCurso(Usuario usuario) async {
    ...
    DocumentSnapshot snapshot = await db
        .collection("cursos")
        .document("Instagram" + "_" + nome + "_" + usuario.email)
        .get();
                        ...
                        children: [
                          Center(
                            child: Container(
                              ...
                              child: Text(
                                cont.toString() + ". COMO CADASTRAR-SE",
                                style: TextStyle(
