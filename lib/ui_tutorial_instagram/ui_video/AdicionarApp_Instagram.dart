...
class AdicionarAPP_Video_Instagram extends StatefulWidget {
  int cont;
  String nome;
  String link;

  AdicionarAPP_Video_Instagram(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _AdicionarAPP_Video_InstagramState createState() =>
      _AdicionarAPP_Video_InstagramState(cont, nome, link);
}

class _AdicionarAPP_Video_InstagramState
    extends State<AdicionarAPP_Video_Instagram> {
  int cont;
  String nome;
  String link;

  _AdicionarAPP_Video_InstagramState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
