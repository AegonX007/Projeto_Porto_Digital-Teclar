...
class LoginAPP_Video_Instagram extends StatefulWidget {
  int cont;
  String nome;
  String link;

  LoginAPP_Video_Instagram(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _LoginAPP_Video_InstagramState createState() =>
      _LoginAPP_Video_InstagramState(cont, nome, link);
}

class _LoginAPP_Video_InstagramState extends State<LoginAPP_Video_Instagram> {
  int cont;
  String nome;
  String link;

  _LoginAPP_Video_InstagramState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
                        ...
                        children: [
                          Center(
                            child: Container(
                              ...
                              child: Text(
                                cont.toString() + ". COMO FAZER LOGIN",
                                style: TextStyle(
