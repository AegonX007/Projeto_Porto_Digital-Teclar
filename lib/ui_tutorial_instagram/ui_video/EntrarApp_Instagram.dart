...
class EntrarAPP_Video_Instagram extends StatefulWidget {
  int cont;
  String nome;
  String link;

  EntrarAPP_Video_Instagram(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _EntrarAPP_Video_InstagramState createState() =>
      _EntrarAPP_Video_InstagramState(cont, nome, link);
}

class _EntrarAPP_Video_InstagramState extends State<EntrarAPP_Video_Instagram> {
  int cont;
  String nome;
  String link;

  _EntrarAPP_Video_InstagramState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
