...
class BaixarAPP_Audio_Ifood extends StatefulWidget {
  int cont;
  String nome;
  String link;

  BaixarAPP_Audio_Ifood(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _BaixarAPP_Audio_IfoodState createState() =>
      _BaixarAPP_Audio_IfoodState(cont, nome, link);
}

// ignore: camel_case_types
class _BaixarAPP_Audio_IfoodState extends State<BaixarAPP_Audio_Ifood> {
  int cont;
  String nome;
  String link;

  _BaixarAPP_Audio_IfoodState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
