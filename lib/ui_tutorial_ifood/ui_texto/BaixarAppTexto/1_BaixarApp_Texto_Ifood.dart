...
class BaixarApp_Texto_Ifood extends StatefulWidget {
  int cont;
  String nome;
  String link;

  BaixarApp_Texto_Ifood(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _BaixarApp_Texto_IfoodState createState() =>
      _BaixarApp_Texto_IfoodState(cont, nome, link);
}

class _BaixarApp_Texto_IfoodState extends State<BaixarApp_Texto_Ifood> {
  int cont;
  String nome;
  String link;

  _BaixarApp_Texto_IfoodState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
