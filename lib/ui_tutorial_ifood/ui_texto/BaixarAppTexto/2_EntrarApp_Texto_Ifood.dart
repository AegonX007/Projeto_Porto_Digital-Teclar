...
class EntrarApp_Texto_Ifood extends StatefulWidget {
  int cont;
  String nome;
  String link;

  EntrarApp_Texto_Ifood(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _EntrarApp_Texto_IfoodState createState() =>
      _EntrarApp_Texto_IfoodState(cont, nome, link);
}

class _EntrarApp_Texto_IfoodState extends State<EntrarApp_Texto_Ifood> {
  int cont;
  String nome;
  String link;

  _EntrarApp_Texto_IfoodState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
