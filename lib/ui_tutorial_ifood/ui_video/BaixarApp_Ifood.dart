...
class BaixarAPP_Video_Ifood extends StatefulWidget {
  int cont;
  String nome;
  String link;

  BaixarAPP_Video_Ifood(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _BaixarAPP_Video_IfoodState createState() =>
      _BaixarAPP_Video_IfoodState(cont, nome, link);
}

// ignore: camel_case_types
class _BaixarAPP_Video_IfoodState extends State<BaixarAPP_Video_Ifood> {
  int cont;
  String nome;
  String link;

  _BaixarAPP_Video_IfoodState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  Widget build(BuildContext context) {
    ...
    var sizeCard = (sizeHeight * 0.867) - (sizeHeight * 0.10);
...
final int cont;
  ...
  const BaixarAPP_Video ({Key key, this.nome, this.cont, this.link}) : super(key: key);
