...
class CadastrarAPP_Video_Ifood extends StatefulWidget {
  int cont;
  String nome;
  String link;

  CadastrarAPP_Video_Ifood(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _CadastrarAPP_Video_IfoodState createState() =>
      _CadastrarAPP_Video_IfoodState(cont, nome, link);
}

class _CadastrarAPP_Video_IfoodState extends State<CadastrarAPP_Video_Ifood> {
  int cont;
  String nome;
  String link;

  _CadastrarAPP_Video_IfoodState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
