...
class EntrarAPP_Video_Ifood extends StatefulWidget {
  int cont;
  String nome;
  String link;

  EntrarAPP_Video_Ifood(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _EntrarAPP_Video_IfoodState createState() =>
      _EntrarAPP_Video_IfoodState(cont, nome, link);
}

class _EntrarAPP_Video_IfoodState extends State<EntrarAPP_Video_Ifood> {
  int cont;
  String nome;
  String link;

  _EntrarAPP_Video_IfoodState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
