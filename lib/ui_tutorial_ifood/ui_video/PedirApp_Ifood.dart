...
class PedirAPP_Video_Ifood extends StatefulWidget {
  int cont;
  String nome;
  String link;

  PedirAPP_Video_Ifood(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _PedirAPP_Video_IfoodState createState() =>
      _PedirAPP_Video_IfoodState(cont, nome, link);
}

class _PedirAPP_Video_IfoodState extends State<PedirAPP_Video_Ifood> {
  int cont;
  String nome;
  String link;

  _PedirAPP_Video_IfoodState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
