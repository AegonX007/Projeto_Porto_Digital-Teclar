...
class LoginAPP_Video_Ifood extends StatefulWidget {
  int cont;
  String nome;
  String link;

  LoginAPP_Video_Ifood(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _LoginAPP_Video_IfoodState createState() =>
      _LoginAPP_Video_IfoodState(cont, nome, link);
}

class _LoginAPP_Video_IfoodState extends State<LoginAPP_Video_Ifood> {
  int cont;
  String nome;
  String link;

  _LoginAPP_Video_IfoodState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
