...
class CadastrarAPP_Video_Whatsapp extends StatefulWidget {
  int cont;
  String nome;
  String link;

  CadastrarAPP_Video_Whatsapp(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _CadastrarAPP_Video_WhatsappState createState() =>
      _CadastrarAPP_Video_WhatsappState(cont, nome, link);
}

class _CadastrarAPP_Video_WhatsappState
    extends State<CadastrarAPP_Video_Whatsapp> {
  int cont;
  String nome;
  String link;

  _CadastrarAPP_Video_WhatsappState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
