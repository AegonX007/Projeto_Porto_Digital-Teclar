...
class LoginAPP_Video_Whatsapp extends StatefulWidget {
  int cont;
  String nome;
  String link;

  LoginAPP_Video_Whatsapp(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _LoginAPP_Video_WhatsappState createState() =>
      _LoginAPP_Video_WhatsappState(cont, nome, link);
}

class _LoginAPP_Video_WhatsappState extends State<LoginAPP_Video_Whatsapp> {
  int cont;
  String nome;
  String link;

  _LoginAPP_Video_WhatsappState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
