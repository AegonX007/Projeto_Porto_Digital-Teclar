...
class EntrarAPP_Video_Whatsapp extends StatefulWidget {
  int cont;
  String nome;
  String link;

  EntrarAPP_Video_Whatsapp(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _EntrarAPP_Video_WhatsappState createState() =>
      _EntrarAPP_Video_WhatsappState(cont, nome, link);
}

class _EntrarAPP_Video_WhatsappState extends State<EntrarAPP_Video_Whatsapp> {
  int cont;
  String nome;
  String link;

  _EntrarAPP_Video_WhatsappState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
