...
class BaixarAPP_Video_Whatsapp extends StatefulWidget {
  int cont;
  String nome;
  String link;

  BaixarAPP_Video_Whatsapp(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _BaixarAPP_Video_WhatsappState createState() =>
      _BaixarAPP_Video_WhatsappState(cont, nome, link);
}

// ignore: camel_case_types
class _BaixarAPP_Video_WhatsappState extends State<BaixarAPP_Video_Whatsapp> {
  int cont;
  String nome;
  String link;

  _BaixarAPP_Video_WhatsappState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
