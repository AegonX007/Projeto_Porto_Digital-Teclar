...
class AdicionarAPP_Video_Whatsapp extends StatefulWidget {
  int cont;
  String nome;
  String link;

  AdicionarAPP_Video_Whatsapp(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _AdicionarAPP_Video_WhatsappState createState() =>
      _AdicionarAPP_Video_WhatsappState(cont, nome, link);
}

class _AdicionarAPP_Video_WhatsappState
    extends State<AdicionarAPP_Video_Whatsapp> {
  int cont;
  String nome;
  String link;

  _AdicionarAPP_Video_WhatsappState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
