...
class BaixarApp_Texto_Whatsapp extends StatefulWidget {
  int cont;
  String nome;
  String link;

  BaixarApp_Texto_Whatsapp(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _BaixarApp_Texto_WhatsappState createState() =>
      _BaixarApp_Texto_WhatsappState(cont, nome, link);
}

class _BaixarApp_Texto_WhatsappState extends State<BaixarApp_Texto_Whatsapp> {
  int cont;
  String nome;
  String link;

  _BaixarApp_Texto_WhatsappState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
