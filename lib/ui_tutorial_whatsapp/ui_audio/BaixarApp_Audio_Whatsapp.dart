...
class BaixarAPP_Audio_Whatsapp extends StatefulWidget {
  int cont;
  String nome;
  String link;

  BaixarAPP_Audio_Whatsapp(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
  ...
  @override
  _BaixarAPP_Audio_WhatsappState createState() =>
      _BaixarAPP_Audio_WhatsappState(cont, nome, link);
}

// ignore: camel_case_types
class _BaixarAPP_Audio_WhatsappState extends State<BaixarAPP_Audio_Whatsapp> {
  int cont;
  String nome;
  String link;

  _BaixarAPP_Audio_WhatsappState(int cont, String nome, String link) {
    this.cont = cont;
    this.nome = nome;
    this.link = link;
  }
